import 'package:a2zshows/MovieDetails/MovieDetail.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart'as http;
import 'dart:convert';

class HighRated extends StatefulWidget {
  const HighRated({super.key});

  @override
  State<HighRated> createState() => _HighRatedState();
}

class _HighRatedState extends State<HighRated> {
  ...
  Future<void> adultSeriesurlFunction2() async {
    try {
      ...
      if (adultTvResponse2.statusCode == 200) {
        ...
        for (int i = 7; i < tempData.length; i++) {
  ...
  Future<void> adultSeriesurlFunction3() async {
    try {
      ...
      if (adultTvResponse3.statusCode == 200) {
        ...
        for (int i = 17; i < tempData.length; i++) {
